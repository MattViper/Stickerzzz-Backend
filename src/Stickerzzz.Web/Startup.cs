...
namespace Stickerzzz.Web
{
	public class Startup
	{
		...
		public IServiceProvider ConfigureServices(IServiceCollection services)
		{
			...
			var connectionString = "Host=stickerzzz-postgres.postgres.database.azure.com;Port=5432;Username=rideryz@stickerzzz-postgres.postgres.database.azure.com;Password=Paramiko12;Database=Stickerzzz;Command Timeout = 0";
